...
const PlanType = ({ day, month, year, indexDay, sortedData, expenseEachList, expenseEachDay, adultAmount, kidAmount, isUseTicket, handleAmountChange, enableEdit, enableEditChange, handleCustomPriceChange }) => {
                    ...
                    {sortedData.map((data, index) => (
                        <div key={index} className='rounded-xl m-2 pt-2 px-2'>
                            ...
                            <details className='pt-1 w-full collapse collapse-arrow flex justify-between'>
                                <summary className="collapse-title min-h-0 p-0 text-sm my-auto">{data.start_time} น.</summary>
